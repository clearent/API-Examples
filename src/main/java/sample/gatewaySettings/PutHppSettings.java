...
import sample.domain.settings.Hpp;
import sample.domain.settings.Terminal;
...
public class PutHppSettings {
    private static final String API_URI = "https://gateway-sb.clearent.net/rest/v2/settings/terminal/hpp";
    ...
    private static String updateTerminal() throws Exception {
        ...
        String jsonCustomer = gson.toJson(hpp);
