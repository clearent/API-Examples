...
import sample.domain.settings.CscFilters;
...
public class PutCscSettings {
    private static final String API_URI = "https://cladevgsops02.clearent.net:8490/rest/v2/settings/terminal/csc";
    ...
    private static String updateTerminal() throws Exception {
        CscFilters filters = new CscFilters();
