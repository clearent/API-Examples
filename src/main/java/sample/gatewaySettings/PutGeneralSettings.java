...
public class PutGeneralSettings {
    private static final String API_URI = "https://gateway-sb.clearent.net/rest/v2/settings/terminal";
    ...
    private static String updateTerminal() throws Exception {
        ...
        String jsonCustomer = gson.toJson(terminal);
