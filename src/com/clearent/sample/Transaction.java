...
public class Transaction{
  ...
  public static String requestSale() throws Exception {
      ...
      final String requestBody = "{\"type\":\"SALE\",\"card\":\"" + card + "\",\"exp-date\":\"" + exp_date + "\",\"amount\":\"" + amount + "\"}";
  ...
  public static String requestAuth() throws Exception {
      ...
      final String exp_date = "1219";
      final String amount = "25.00";
      final String requestBody = "{\"type\":\"AUTH\",\"card\":\"" + card + "\",\"exp-date\":\"" + exp_date + "\",\"amount\":\"" + amount + "\"}";
      return requestTransaction(requestBody);
  }
  ...
  public static String requestCapture() throws Exception {
      ...
      final String amount = "25.00";
      final String requestBody = "{\"type\":\"CAPTURE\",\"id\":\"" + id + "\",\"amount\":\"" + amount + "\"}";
      return requestTransaction(requestBody);
  }
  ...
  public static String requestForcedSale() throws Exception {
      ...
      final String requestBody = "{\"type\":\"FORCED SALE\",\"card\":\"" + card + "\",\"exp-date\":\"" + exp_date + "\",\"amount\":\"" + amount + "\",\"order-id\":\"" + order_id + "\",\"authorization-code\":\"" + authorization_code + "\"}";
      return requestTransaction(requestBody);
  }
  ...
  public static String requestRefund() throws Exception {
      final String card = "4111111111111111";
      final String amount = "25.00";
      final String requestBody = "{\"type\":\"REFUND\",\"card\":\"" + card + "\",\"amount\":\"" + amount + "\"}";
      return requestTransaction(requestBody);
  }
  ...
  private static String requestTransaction(String requestBody) throws IOException {
  ...
  private static HttpURLConnection openHttpConnection(final URL url) {
    try {
      ...
      throw new IllegalStateException("Unable to open connection with endpoint", ioe);
    }
  }
  ...
  private static void sendRequest(final String requestBody, final OutputStream outputStream) {
    try {
  ...
  private static void setRequestParamters(final HttpURLConnection httpConnection, String apiKey) throws ProtocolException {
